<div class="dashboard">
    ...
    <div class="dashboard-content">
        <div class="header-section">
            <h1><i class="fas fa-plus-circle"></i> Ajouter une tâche</h1>
        ...
        <div class="form-container" style="max-width: 600px; margin: 0 auto;">
            <form method="POST" action="<?= WEBROOT ?>?controller=tache&action=add">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="3" 
                              placeholder="Description détaillée..."><?= htmlspecialchars($tache['description'] ?? '') ?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="etat_id">
                        <i class="fas fa-info-circle"></i> État initial
                    </label>
